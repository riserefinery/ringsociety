        ...
        <div className="mt-9 legal-document">
          <ReactMarkdown
            ...
            components={{
              ...
              p: ({ children }) => <p className="mt-5 text-[16px] leading-[1.75] text-[#3f4642] md:text-[17px]">{children}</p>,
              ...
              ul: ({ children }) => <ul className="mt-5 list-disc space-y-2 pl-6 text-[16px] leading-[1.75] text-[#3f4642] md:text-[17px]">{children}</ul>,
              ol: ({ children }) => <ol className="mt-5 list-decimal space-y-2 pl-6 text-[16px] leading-[1.75] text-[#3f4642] md:text-[17px]">{children}</ol>,
