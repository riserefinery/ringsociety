    ...
    <section className="w-full bg-[#f9f6f2] px-5 py-14 md:px-10 md:py-24">
      <article className="mx-auto max-w-[860px] rounded-[2px] bg-white px-6 py-10 shadow-[0_12px_48px_rgba(27,33,29,0.06)] md:px-14 md:py-16">
        ...
        {showPrivacyRequestNote && (
          <aside className="mt-8 rounded-[2px] border border-[rgba(36,71,55,0.16)] bg-[#f3f7f1] p-5 text-[15px] leading-[1.65] text-[#314338] md:p-6">
            <p className="font-semibold text-[#1b211d]">Making a privacy request</p>
            <p className="mt-2">
        ...
        <div className="mt-9 legal-document">
          <ReactMarkdown
            ...
            components={{
              ...
              p: ({ children }) => <p className="mt-5 text-[17px] leading-[1.5] text-[#3f4642] md:leading-[1.75]">{children}</p>,
              ...
              ul: ({ children }) => <ul className="mt-5 list-disc space-y-2 pl-6 text-[17px] leading-[1.5] text-[#3f4642] md:leading-[1.75]">{children}</ul>,
              ol: ({ children }) => <ol className="mt-5 list-decimal space-y-2 pl-6 text-[17px] leading-[1.5] text-[#3f4642] md:leading-[1.75]">{children}</ol>,
