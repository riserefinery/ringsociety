...
describe('footer responsive layout', () => {
  it('uses a deliberate four-column small-laptop grid without changing the mobile stack', () => {
    ...
    expect(footer).toContain("to: '/guides/how-to-choose-a-jeweler'")
    expect(footer).toContain("to: '/guides/how-to-buy-an-engagement-ring'")
    expect(footer).toContain("to: '/guides/engagement-ring-budgets'")
    expect(footer).toContain("to: '/guides/natural-vs-lab-grown-diamonds'")
    expect(footer).toContain("to: '/guides/4cs-of-diamonds'")
