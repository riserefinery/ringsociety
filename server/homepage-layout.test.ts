...
describe('shared full-bleed hero and CTA layout', () => {
  ...
  it('keeps the approved mobile type scale and supplied favicon wired through the shared templates', () => {
    ...
    expect(favicon).toContain('/manus-storage/ring-society-icon-black-32_4a921a30.png')
    expect(favicon).toContain('/manus-storage/ring-society-icon-black-180_a8b9a44c.png')
    expect(favicon).toContain('/manus-storage/ring-society-icon-black-192_728ed91e.png')
    expect(favicon).toContain('/manus-storage/ring-society-icon-black-tab-safe_00e572aa.ico')
    expect(favicon).toContain('v=20260818-2')
    expect(favicon).toContain('v=20260818-3')
