...
const guides = [
  ...
  { slug: 'engagement-ring-trends-2026', category: 'Trends', title: 'The Most Popular & Trending Ring Styles and Diamond Shapes in 2026', excerpt: 'Discover the ring styles and diamond trends shaping 2026.', cta: 'trending diamond rings', image: 'trending', alt: 'A brilliant-cut diamond ring resting on textured fabric', filters: ['trends'] },
  ...
  { slug: 'big-box-vs-local-vs-online-jewelers', category: 'Guide', title: 'Go Big or Shop Small? Big-Box vs. Local vs. Online Jewelers', excerpt: 'How national chains, online-only retailers, and independent local jewelers differ.', cta: 'view the guide', image: 'emerald', alt: 'A gold ring set with an emerald-green stone', filters: ['jeweler', 'perspectives'], bigFeature: 'bigFeatureBigBox' },
...
async function main() {
  ...
  const topGuideSlugs = ['how-to-choose-a-jeweler', 'engagement-ring-budgets', 'natural-vs-lab-grown-diamonds', 'how-to-buy-an-engagement-ring', 'engagement-ring-settings-and-styles', 'big-box-vs-local-vs-online-jewelers', 'what-drives-diamond-pricing', 'ultimate-guide-to-diamond-clarity']
  await client.createOrReplace({
